                    ...
                    foreach ($kategori  as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?= $value->id_kategori ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h4>Apakah anda yakin ingin menghapus <?= $value->nama_kategori ?> dari data kategori...?</h4>
