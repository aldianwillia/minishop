<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title"> Add Gambar : <?= $barang->nama_barang  ?></h3>

            <div class="card-tools">
                <a href="<?= base_url('barang/add') ?>" type="button" class="btn btn-primary"><i class="fas fa-plus"></i>
                    Add</a>
            </div>
            <!-- /.card-tools -->
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/gambar3.jpg') ?>" id="gambar_load" width="250px">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <a href="<?= base_url('gambarbarang') ?>" class="btn btn-success btn-sm">Cencel</a>
            </div>
            ...
            <div class="row">
                <?php foreach ($gambar as $key => $value) { ?>
                    <div class="col-sm-3">
                        ...
                        <button data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>" class="btn btn-danger  btn-block"><i class="fas fa-trash"></i></button>
                    </div>
                <?php } ?>
