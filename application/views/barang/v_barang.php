                    ...
                    foreach ($barang as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value->id_barang ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5>Apakah anda yakin ingin menghapus <?= $value->nama_barang ?> dari data barang...?</h5>
