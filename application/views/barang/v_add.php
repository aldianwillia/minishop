    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" cols="30" rows="5" name="deskripsi"><?= set_value('deskripsi') ?></textarea>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="gambar" id="preview_gambar" required><?= set_value('gambar') ?>
                    </div>
                </div>

                <div class="col-sm-6">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/gambar3.jpg') ?>" id="gambar_load" width="300px">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <a href="<?= base_url('barang') ?>" class="btn btn-success btn-sm">Cencel</a>
            </div>
